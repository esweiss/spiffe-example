...
var (
	...
	envoyToEnvoyFlag = flag.String("envoy-to-envoy", "localhost:8001", "address to the envoy-to-envoy endpoint")
	envoyToProxyFlag = flag.String("envoy-to-proxy", "localhost:8002", "address to the envoy-to-proxy endpoint")
...
<body>
	<div class="button-grid-container">
		...
		<div class="grid-item">
			<button onclick="location.assign('/?route=envoy-to-envoy');">Envoy &#8594; Envoy</button>
		</div>
		<div class="grid-item">
			<button onclick="location.assign('/?route=envoy-to-proxy');">Envoy &#8594; Layer 7 Proxy &#8594; Envoy</button>
		</div>
	</div>
	<br/>
{{- if .WebHeader }}
...
func serveRoot(w http.ResponseWriter, r *http.Request) {
	...
	case "direct":
		host = *directFlag
	case "envoy-to-envoy":
		host = *envoyToEnvoyFlag
	case "envoy-to-proxy":
		host = *envoyToProxyFlag
	default:
